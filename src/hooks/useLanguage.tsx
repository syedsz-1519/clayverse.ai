...
const dictionary: Record<string, Record<string, string>> = {
  en: {
    ...
    // Hero Section
    'hero.badge': '✨ 100% Beginner-Safe • Zero Math & Zero Jargon • Human Coded',
  ...
  hinglish: {
    ...
    'brand.constructed': '© 2026 Clayverse AI. By Syed Shahnawaz.',
    'hero.badge': '✨ 100% Beginners Ke Liye • Zero Math & Zero Jargon • Human Coded',
  ...
  thanglish: {
    ...
    'hero.badge': '✨ 100% Beginners-ku • Zero Math & Zero Jargon • Human Coded',
  ...
  roman_ur: {
    ...
    'hero.badge': '✨ 100% Naye Seekhne Walo Ke Liye • Zero Math • Human Coded',
  ...
  hyd: {
    ...
    'hero.badge': '✨ 100% Asaan Sabaq • Na Koi Math, Na Koi Jargon • Human Coded',
  ...
  hi: {
    ...
    'hero.badge': '✨ 100% शुरुआती पाठकों के लिए • बिना किसी गणित के • Human Coded',
  ...
  te: {
    ...
    'hero.badge': '✨ 100% ప్రారంభకులకు అనుకూలం • గణితం మరియు కష్టమైన పదాలు లేవు • Human Coded',
  ...
  bn: {
    ...
    'hero.badge': '✨ ১০০% নতুনদের উপযোগী • কোনো জটিল গণিত ছাড়া • Human Coded',
  ...
  mr: {
    ...
    'hero.badge': '✨ 100% नवशिक्यांसाठी • शून्य गणित • Human Coded',
  ...
  ta: {
    ...
    'hero.badge': '✨ 100% ஆரம்பநிலையாளர்களுக்கானது • கணிதம் இல்லை • Human Coded',
  ...
  ur: {
    ...
    'hero.badge': '✨ 100% مبتدی طلبہ کے لیے • آسان اور عام فہم • Human Coded',
  ...
  gu: {
    ...
    'hero.badge': '✨ 100% નવા શીખનારાઓ માટે • સરળ ભાષા • Human Coded',
  ...
  kn: {
    ...
    'hero.badge': '✨ 100% ಆರಂಭಿಕರಿಗೆ ಸೂಕ್ತ • ಸರಳ ಕಲಿಕೆ • Human Coded',
  ...
  or: {
    ...
    'hero.badge': '✨ 100% ନୂତନ ଶିକ୍ଷାର୍ଥୀଙ୍କ ପାଇଁ • ସରଳ ଭାଷା • Human Coded',
  ...
  ml: {
    ...
    'hero.badge': '✨ തുടക്കക്കാർക്കായി 100% അനുയോജ്യം • Human Coded',
  ...
  pa: {
    ...
    'hero.badge': '✨ 100% ਨਵੇਂ ਸਿੱਖਣ ਵਾਲਿਆਂ ਲਈ • Human Coded',
  ...
  as: {
    ...
    'hero.badge': '✨ ১০০% নতুন শিক্ষাৰ্থীৰ বাবে • Human Coded',
  ...
  mai: {
    ...
    'hero.badge': '✨ १००% शुरुआती लोकनिक लेल • Human Coded',
  ...
  sa: {
    ...
    'hero.badge': '✨ प्राथमिकाभ्यासार्थिभ्यः १००% • Human Coded',
